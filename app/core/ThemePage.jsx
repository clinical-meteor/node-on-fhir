...
export function ThemePage(props){
  ...
  return(
    <div id='themePage' className={props.classes.page} >
      <Grid container direction="row" justify="space-evenly" alignItems="stretch" className={ props.classes.root} spacing={3} >

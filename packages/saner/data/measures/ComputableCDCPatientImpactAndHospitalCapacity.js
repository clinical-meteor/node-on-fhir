const ComputableCDCPatientImpactAndHospitalCapacity = {
    ...
    },
    {
      ...
      "population" : [
        ...
        },
        {
          ...
          "criteria" : {
            "description" : "ctive encounters where the encounter diagnosis is suspected or confirmed COVID-19,\nor a Condition of suspected or confirmed COVID-19 was created during that encounter.",
            "name" : "numC19Pats",
            "language" : "text/fhirpath",
            "expression" : "ncounter.where(clinicalStatus = 'active' and diagnosis.condition.ofType(Condition).code in %ValueSet-SuspectedOrDiagnosedCOVID19)\n| Encounter.where(clinicalStatus = \"active\" and Condition.where(code in %ValueSet-SuspectedOrDiagnosedCOVID19).encounter = $this)"
          }
        },
        {
          "code" : {
...
export default ComputableCDCPatientImpactAndHospitalCapacity;
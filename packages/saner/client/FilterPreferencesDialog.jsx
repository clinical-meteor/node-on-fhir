...
function FilterPreferencesDialog(props){
  ...
  let [queryStartDate, setQueryStartDate] = useState(moment().subtract(1, 'day').format("YYYY-MM-DD"));
  ...
  let [populationCodeText, setPopulationCodeText] = useState("numBeds");
              ...
              <div>
                ...
                <FormControl style={{width: '100%', marginTop: '20px'}}>
                  ...
                  >
                    ...
                    <MenuItem value={2}>Ventilators</MenuItem>
                    <MenuItem value={3}>Encounters</MenuItem>
                  </Select>
                </FormControl>
                <FormControl style={{width: '100%', marginTop: '20px'}}>

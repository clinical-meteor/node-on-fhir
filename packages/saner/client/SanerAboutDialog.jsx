...
function SanerAboutDialog(props){
  ...
  return (
    <DialogContent dividers={scroll === 'paper'} style={{minWidth: '600px', fontSize: '120%', marginBottom: '20px'}}>
      This project implements the <a href="https://github.com/AudaciousInquiry/saner-ig">Situation Awareness for Novel Epidemic Response</a> specification from HL7 International, and has been submitted to the <a href="https://datavant.com/pandemic-response-hackathon/">Datavant Pandemic Response Hackathon</a>, the <a href="https://covid19challenge.mit.edu/">MIT Covid19 Challenge</a>, and the <a href="https://waters.crowdicity.com/category/51403">COVID-19 At-Anywhere Diagnostics Design-a-thon</a>.  In May 2020, we validated this prototype against testing servers run by <a href="https://www.forbes.com/sites/thomasbrewster/2020/07/13/inside-americas-secretive-2-billion-research-hub-collecting-fingerprints-from-facebook-hacking-smartwatches-and-fighting-covid-19/?sh=278a9b572052">MITRE</a>, the operator of the federal R&D labs for HHS and the Centers for Medicare and Medicaid.  Later, in September, we further validated the prototype with the CDC National Healthcare Safety Network.     
      <br /><br />
